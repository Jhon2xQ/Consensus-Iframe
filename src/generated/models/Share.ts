...
export type ShareWhereInput = {
  ...
  share?: Prisma.StringFilter<"Share"> | string
...
export type ShareScalarWhereWithAggregatesInput = {
  ...
  share?: Prisma.StringWithAggregatesFilter<"Share"> | string
...
export type ShareOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "userId" | "share" | "createdAt" | "updatedAt", ExtArgs["result"]["share"]>
...
export interface ShareFieldRefs {
  ...
  readonly share: Prisma.FieldRef<"Share", 'String'>
